...
<head>
	...
	<link rel="stylesheet" href="<%=new ENV().baseUrl %>/css/me.css" type="text/css" />
</head>
<body>
	<div class="container bs-docs-container">
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
						<ul class="nav navbar-nav">
							...
							<li><a href="<%=new ENV().baseUrl %>/front/0/front">前端</a></li>
				      		...
				      		<li><a href="<%=new ENV().baseUrl %>/me" style="color:#FF8322;padding:0 23px;">关于我</a></li>
						</ul>
					</nav>
				</div>
			</header>
		...
		<div class="row">
			<div id="articleItems" class="col-md-8" role="main">
				<h2 style="text-align:center;margin-top:5px;">关于我</h2>
				<br/>
				<p>本人承接网站开发！</p>
				<p>在这里，不急、不燥，让我们慢慢积累，厚积薄发！</p>
				<p>成功的人不是赢在起点，而是赢在转折点，请好好的出发，千里之行始于足下，想要出发就有希望等到终点。</p>
				<p>我们必须学会选择，懂得放弃，给自己一个明确的定位，否则就会被别人和社会定型。只要自己不把自己束缚在牢笼里，谁也束缚不了我展翅高飞。</p>
				<p>美国作家杰克·凯鲁亚克说过一句话：＂我还年轻，我渴望上路。＂在人生的旅途中，我们永远都是年轻人，每天都应该满怀渴望。</p>
				<p>每个人的潜能都是无限的，关键是要发现自己的潜能和自己的才能，并找到一个能够充分发挥潜能的舞台，还不能只为舞台的不合适感到不快，要客观公正的看待自己的能力，结合自己的实际和爱好冷静选择。尽可能到最需要自己、最适合自己的地方。</p>
				<br/>	
				<h3>联系我</h3>
				<p>邮箱&nbsp;:&nbsp;qsjdhm@163.com</p>
				<p>QQ&nbsp;:&nbsp;623585268</p>
				<p>欢迎热衷于前端开发的同学们与我交流  O(∩_∩)O~</p>
				<br/><br/>
	...
	<script type="text/javascript" src="<%=new ENV().baseUrl %>/js/me.js"></script>
