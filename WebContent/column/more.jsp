...
<head>
	...
	<link rel="stylesheet" href="<%=new ENV().baseUrl %>/css/more.css" type="text/css" />
</head>
<body>
	...
	<script type="text/javascript" src="<%=new ENV().baseUrl %>/js/more.js"></script>
