...
<head>
	...
	<link rel="stylesheet" href="<%=new ENV().baseUrl %>/css/works.css" type="text/css" />
</head>
<body>
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
						<ul class="nav navbar-nav">
							...
							<li><a href="<%=new ENV().baseUrl %>/front/0/front">前端</a></li>
				      		...
				      		<li><a href="<%=new ENV().baseUrl %>/works/0/works" style="color:#FF8322;padding:0 23px;">个人作品</a></li>
	...
	<script type="text/javascript" src="<%=new ENV().baseUrl %>/js/works.js"></script>
