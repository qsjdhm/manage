...
<head>
	...
	<link rel="stylesheet" href="<%=new ENV().baseUrl %>/css/search.css" type="text/css" />
</head>
<body>
	<div class="container bs-docs-container">
		...
		<div class="row searchKeywordTipsDiv">
			<p style="float:left;">搜索关键字&nbsp;&nbsp;:&nbsp;&nbsp;</p><p id="searchKeywordTips">${keyword}</p>
		</div>
	...
	<input type="hidden" id="keyWordHiddenInput" value="${keyword}" />
	...
	<script type="text/javascript" src="<%=new ENV().baseUrl %>/js/search.js"></script>
