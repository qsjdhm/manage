...
<head>
	...
	<link rel="stylesheet" href="<%=new ENV().baseUrl %>/css/book.css" type="text/css" />
	<link rel="stylesheet" href="<%=new ENV().baseUrl %>/plugins/Wookmark-jQuery-master/css/reset.css" type="text/css" />
    <link rel="stylesheet" href="<%=new ENV().baseUrl %>/plugins/Wookmark-jQuery-master/css/main.css" type="text/css" />
    <link rel="stylesheet" href="<%=new ENV().baseUrl %>/plugins/Wookmark-jQuery-master/example-filter/css/style.css" type="text/css" />
</head>
<body>
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
						<ul class="nav navbar-nav">
							...
							<li><a href="<%=new ENV().baseUrl %>/front/0/front">前端</a></li>
				      		...
				      		<li><a href="<%=new ENV().baseUrl %>/book/3/0/book" style="color:#FF8322;padding:0 23px;">读书乐趣</a></li>
	...
	<script type="text/javascript" src="<%=new ENV().baseUrl %>/plugins/Wookmark-jQuery-master/jquery.wookmark.js"></script>
	<script type="text/javascript" src="<%=new ENV().baseUrl %>/plugins/search/js/zySearch-doit.js"></script>
	<script type="text/javascript" src="<%=new ENV().baseUrl %>/js/book.js"></script>
