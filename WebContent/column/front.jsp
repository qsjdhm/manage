...
<head>
	...
	<link rel="stylesheet" href="<%=new ENV().baseUrl %>/css/front.css" type="text/css" />
</head>
<body>
				...
				<div class="container">
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
						<ul class="nav navbar-nav">
							...
							<li><a href="<%=new ENV().baseUrl %>/front/0/front" style="color:#FF8322;padding:0 23px;">前端</a></li>
	...
	<script type="text/javascript" src="<%=new ENV().baseUrl %>/js/front.js"></script>
