...
public class DatabaseBackup {
    ...
    public static boolean exportDatabaseTool(String hostIP, String userName, String password, String savePath, String fileName, String databaseName) {
        ...
        stringBuilder.append("C://Program Files//MySQL//MySQL Server 5.0//bin//mysqldump").append(" --opt").append(" -h").append(hostIP);
    ...
    public static void main(String[] args) throws InterruptedException {
        if (exportDatabaseTool("localhost", "root", "000000", "D:/", "2014-10-14.sql", "manage")) {
